...
pub struct NodeLinkConfig {
    ...
    #[serde(rename = "voiceReceive", alias = "voice_receive")]
    pub voice_receive: VoiceReceiveConfig,
    #[serde(rename = "routePlanner", alias = "route_planner")]
    pub route_planner: RoutePlannerConfig,
    pub mix: MixConfig,
    #[serde(rename = "pluginConfig", alias = "plugin_config")]
    pub plugin_config: Option<serde_json::Value>,
    #[serde(default, alias = "defaultSearchSource")]
    pub default_search_source: Vec<String>,
    #[serde(default, alias = "unifiedSearchSources")]
    pub unified_search_sources: Vec<String>,
    #[serde(default, alias = "maxSearchResults")]
    pub max_search_results: usize,
    #[serde(default, alias = "maxAlbumPlaylistLength")]
    pub max_album_playlist_length: usize,
    #[serde(default, alias = "playerUpdateInterval")]
    pub player_update_interval: u64,
    #[serde(default, alias = "statsUpdateInterval")]
    pub stats_update_interval_ms: u64,
    #[serde(default, alias = "trackStuckThresholdMs")]
    pub track_stuck_threshold_ms: u64,
    #[serde(default, alias = "eventTimeoutMs")]
    pub event_timeout_ms: u64,
    #[serde(default, alias = "zombieThresholdMs")]
    pub zombie_threshold_ms: u64,
    #[serde(default, alias = "enableHoloTracks")]
    pub enable_holo_tracks: bool,
    #[serde(default, alias = "enableTrackStreamEndpoint")]
    pub enable_track_stream_endpoint: bool,
    #[serde(default, alias = "enableLoadStreamEndpoint")]
    pub enable_load_stream_endpoint: bool,
    #[serde(default, alias = "resolveExternalLinks")]
    pub resolve_external_links: bool,
    #[serde(default, alias = "fetchChannelInfo")]
    pub fetch_channel_info: bool,
    #[serde(default, alias = "cacheEncryptionKey")]
...
impl Default for NodeLinkConfig {
    fn default() -> Self {
        Self {
            ...
            player_update_interval: 2000,
            stats_update_interval_ms: 30000,
            track_stuck_threshold_ms: 10_000,
            event_timeout_ms: 15_000,
            zombie_threshold_ms: 60_000,
            enable_holo_tracks: false,
            enable_track_stream_endpoint: false,
            enable_load_stream_endpoint: false,
...
pub struct ServerConfig {
    ...
    #[serde(default, alias = "useBunServer", alias = "use_bun_server")]
    pub use_bun_server: bool,
}
...
pub struct ClusterRuntimeConfig {
    #[serde(default, alias = "workerMaxOldSpaceMb")]
    pub worker_max_old_space_mb: usize,
    #[serde(default, alias = "workerExposeGc")]
    pub worker_expose_gc: bool,
    #[serde(default, alias = "workerExecArgv")]
    pub worker_exec_argv: Vec<String>,
    #[serde(default, alias = "sourceWorkerMaxOldSpaceMb")]
    pub source_worker_max_old_space_mb: usize,
    #[serde(default, alias = "sourceWorkerExposeGc")]
    pub source_worker_expose_gc: bool,
    #[serde(default, alias = "sourceWorkerExecArgv")]
    pub source_worker_exec_argv: Vec<String>,
}
...
pub struct ClusterConfig {
    pub enabled: bool,
    pub workers: usize,
    #[serde(default, alias = "minWorkers")]
    pub min_workers: usize,
    #[serde(default, alias = "commandTimeout")]
    pub command_timeout: u64,
    #[serde(default, alias = "fastCommandTimeout")]
    pub fast_command_timeout: u64,
    #[serde(default, alias = "maxRetries")]
    pub max_retries: usize,
    pub process_mode: WorkerProcessMode,
    #[serde(default, alias = "specializedSourceWorker")]
    ...
    #[serde(default)]
    pub runtime: ClusterRuntimeConfig,
}
...
impl Default for ClusterConfig {
    fn default() -> Self {
        Self {
            ...
            runtime: ClusterRuntimeConfig::default(),
        }
    }
}
...
pub struct SpecializedSourceWorkerConfig {
    pub enabled: bool,
    pub count: usize,
    #[serde(default, alias = "microWorkers")]
    pub micro_workers: usize,
    #[serde(default, alias = "tasksPerWorker")]
    pub tasks_per_worker: usize,
    #[serde(default, alias = "silentLogs")]
...
pub struct ConnectionConfig {
    #[serde(default, alias = "logAllChecks")]
...
pub struct MetricsConfig {
    pub enabled: bool,
    // NodeLink style: metrics.authorization { type, username, password }
    #[serde(default)]
    pub authorization: MetricsAuthConfig,
    // Backwards compat for RustLink flat style: metrics.username/password
...
impl Default for MetricsConfig {
    fn default() -> Self {
        Self {
            enabled: true,
            authorization: MetricsAuthConfig::default(),
            username: "admin".into(),
            password: None,
            interval: 5_000,
        }
...
pub struct RateLimitConfig {
    pub enabled: bool,
    #[serde(alias = "maxRequests", alias = "max_requests")]
    pub max_requests: u32,
    #[serde(alias = "windowMs", alias = "window_ms")]
    pub window_ms: u64,
    pub global: RateLimitTierConfig,
    #[serde(rename = "perIp", alias = "per_ip")]
    pub per_ip: RateLimitTierConfig,
    #[serde(rename = "perUserId", alias = "per_user_id")]
    pub per_user_id: RateLimitTierConfig,
    #[serde(rename = "perGuildId", alias = "per_guild_id")]
    pub per_guild_id: RateLimitTierConfig,
    #[serde(rename = "ignorePaths", alias = "ignore_paths")]
...
pub struct RateLimitTierConfig {
    #[serde(rename = "maxRequests", alias = "max_requests")]
    pub max_requests: u32,
    #[serde(rename = "timeWindowMs", alias = "time_window_ms")]
...
pub struct RateLimitIgnoreConfig {
    ...
    #[serde(rename = "guildIds", alias = "guild_ids")]
...
pub struct DosThresholds {
    #[serde(rename = "burstRequests", alias = "burst_requests")]
...
pub struct DosMitigation {
    ...
    pub delay_ms: u64,
    #[serde(rename = "blockDurationMs", alias = "block_duration_ms")]
...
pub struct AudioConfig {
    ...
    #[serde(default, alias = "resamplingQuality")]
    pub resampling_quality: String,
    #[serde(default, alias = "loudnessNormalizer")]
    pub loudness_normalizer: bool,
    #[serde(default, alias = "lookaheadMs")]
    pub lookahead_ms: u64,
    #[serde(default, alias = "gateThresholdLUFS")]
...
pub struct CrossfadeConfig {
    ...
    pub curve: String,
    pub mode: String,
    #[serde(default, alias = "minBufferMs")]
    pub min_buffer_ms: u64,
    #[serde(default, alias = "bufferMs")]
    pub buffer_ms: u64,
}
...
pub struct EnabledFiltersConfig {
    ...
    pub karaoke: bool,
    pub distortion: bool,
    #[serde(default, alias = "channelMix")]
...
pub struct SponsorBlockConfig {
    ...
    #[serde(default, alias = "actionTypes")]
    pub action_types: Vec<String>,
    #[serde(default, alias = "skipMarginMs")]
